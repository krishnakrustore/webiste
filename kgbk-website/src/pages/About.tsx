  ...
  return (
    <div>
      ...
      <EditorialSection
        ...
        body="Krishna Gari Battala Kottu began as a family pursuit of fine textiles — a belief that the right fabric changes how an occasion is remembered. Today, from our studio near Peddamma Temple in Jubilee Hills, we work directly with weaving clusters across India to bring authentic silk, cotton and designer fabrics to Hyderabad."
      ...
      <EditorialSection
        ...
        body="We don't run an online checkout — every enquiry becomes a conversation. Browse our catalogue, find what speaks to you, and message us directly on WhatsApp. Our team will guide you through availability, customisation and pricing, just as they would in the studio."
        image="https://images.pexels.com/photos/28943572/pexels-photo-28943572.jpeg?auto=compress&cs=tinysrgb&w=1000"
        reverse
        cta={{ label: "Visit Our Studio", to: "/contact" }}
      />
